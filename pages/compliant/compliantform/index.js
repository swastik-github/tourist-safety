  ...
  const onFinish = async (values) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:1000/complaint/compliantform",
        values,
        {
          headers: {
            Authorization: token,
      ...
      if (response) {
        ...
        router.replace("/compliant/viewreports");
      } else {
      ...
      >
        ...
        >
          <Select placeholder="Please select">
            ...
            <Option value="business">Safety</Option>
            <Option value="employee">hygiene</Option>
          </Select>
        </Form.Item>
        <Form.Item
          name="state"
        ...
        <Form.Item
          ...
          label="Incident Type"
          rules={[
            { required: true, message: "Please select your incident type!" },
          ]}
        >
          <Select placeholder="Please select">
        ...
        <Form.Item
          ...
          rules={[
            { required: true, message: "Please write minimum 50 character !" },
          ]}
        >
          <TextArea rows={4} />
        </Form.Item>
